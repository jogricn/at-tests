...
checkRatingElements = function checkRatingElements(test) {
  test.assertVisible('div.ratings', 'Rating elements are visible!');

  test.assertVisible('div.ratings div:nth-of-type(1) div.rating-name', '  - "Behandlung" rating element is visible!');
  test.assertVisible('div.ratings div:nth-of-type(2) div.rating-name', '  - "Wartezeit" rating element is visible!');
  test.assertVisible('div.ratings > div:nth-of-type(3) > div.rating-name', '  - "Gesamtbewertung" rating element is visible!');
}
